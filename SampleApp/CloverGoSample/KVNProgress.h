...
#define CancelButtonClickedOnProgressWindowEventNotification @"CancelButtonClickedOnProgressWindowEvent"
...
/**
 Modified - RV
 Add Cancel button to new full screen dialogue
 */
...
/**
 Modified - RV
 Initiate Reader Reset Animation to new full screen dialogue
 */
...
/**
 Modified - RV
 Update Reader Reset progress to new full screen dialogue
 */
...
/**
 Modified - RV
 Finish Reader Reset progress to new full screen dialogue
 */
